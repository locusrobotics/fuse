...
TEST(Unicycle2D, UpdateStateHistoryEstimates)
{
  ...
  auto position1 = fuse_variables::Position2DStamped::make_shared(fuse_core::TimeStamp(1, 0));
  auto yaw1 = fuse_variables::Orientation2DStamped::make_shared(fuse_core::TimeStamp(1, 0));
  auto linear_velocity1 = fuse_variables::VelocityLinear2DStamped::make_shared(fuse_core::TimeStamp(1, 0));
  auto yaw_velocity1 = fuse_variables::VelocityAngular2DStamped::make_shared(fuse_core::TimeStamp(1, 0));
  auto linear_acceleration1 = fuse_variables::AccelerationLinear2DStamped::make_shared(fuse_core::TimeStamp(1, 0));
  position1->x() = 1.1;
  position1->y() = 2.1;
  yaw1->yaw() = 3.1;
  ...
  auto position2 = fuse_variables::Position2DStamped::make_shared(fuse_core::TimeStamp(2, 0));
  auto yaw2 = fuse_variables::Orientation2DStamped::make_shared(fuse_core::TimeStamp(2, 0));
  auto linear_velocity2 = fuse_variables::VelocityLinear2DStamped::make_shared(fuse_core::TimeStamp(2, 0));
  auto yaw_velocity2 = fuse_variables::VelocityAngular2DStamped::make_shared(fuse_core::TimeStamp(2, 0));
  auto linear_acceleration2 = fuse_variables::AccelerationLinear2DStamped::make_shared(fuse_core::TimeStamp(2, 0));
  position2->x() = 1.2;
  position2->y() = 2.2;
  yaw2->yaw() = M_PI / 2.0;
  ...
  auto position3 = fuse_variables::Position2DStamped::make_shared(fuse_core::TimeStamp(3, 0));
  auto yaw3 = fuse_variables::Orientation2DStamped::make_shared(fuse_core::TimeStamp(3, 0));
  auto linear_velocity3 = fuse_variables::VelocityLinear2DStamped::make_shared(fuse_core::TimeStamp(3, 0));
  auto yaw_velocity3 = fuse_variables::VelocityAngular2DStamped::make_shared(fuse_core::TimeStamp(3, 0));
  auto linear_acceleration3 = fuse_variables::AccelerationLinear2DStamped::make_shared(fuse_core::TimeStamp(3, 0));
  position3->x() = 1.3;
  position3->y() = 2.3;
  yaw3->yaw() = 3.3;
  ...
  auto position4 = fuse_variables::Position2DStamped::make_shared(fuse_core::TimeStamp(4, 0));
  auto yaw4 = fuse_variables::Orientation2DStamped::make_shared(fuse_core::TimeStamp(4, 0));
  auto linear_velocity4 = fuse_variables::VelocityLinear2DStamped::make_shared(fuse_core::TimeStamp(4, 0));
  auto yaw_velocity4 = fuse_variables::VelocityAngular2DStamped::make_shared(fuse_core::TimeStamp(4, 0));
  auto linear_acceleration4 = fuse_variables::AccelerationLinear2DStamped::make_shared(fuse_core::TimeStamp(4, 0));
  position4->x() = 1.4;
  position4->y() = 2.4;
  yaw4->yaw() = 3.4;
  ...
  auto position5 = fuse_variables::Position2DStamped::make_shared(fuse_core::TimeStamp(5, 0));
  auto yaw5 = fuse_variables::Orientation2DStamped::make_shared(fuse_core::TimeStamp(5, 0));
  auto linear_velocity5 = fuse_variables::VelocityLinear2DStamped::make_shared(fuse_core::TimeStamp(5, 0));
  auto yaw_velocity5 = fuse_variables::VelocityAngular2DStamped::make_shared(fuse_core::TimeStamp(5, 0));
  auto linear_acceleration5 = fuse_variables::AccelerationLinear2DStamped::make_shared(fuse_core::TimeStamp(5, 0));
  position5->x() = 1.5;
  position5->y() = 2.5;
  yaw5->yaw() = 3.5;
  ...
  // Check the state estimates in the state history
  {
    ...
    auto actual_pose = state_history[fuse_core::TimeStamp(1, 0)].pose;
    ...
    auto actual_linear_velocity = state_history[fuse_core::TimeStamp(1, 0)].velocity_linear;
    ...
    auto actual_yaw_velocity = state_history[fuse_core::TimeStamp(1, 0)].velocity_yaw;
    EXPECT_NEAR(expected_yaw_velocity, actual_yaw_velocity, 1.0e-9);

    auto expected_linear_acceleration = tf2_2d::Vector2(0.0, 0.0);
    auto actual_linear_acceleration = state_history[fuse_core::TimeStamp(1, 0)].acceleration_linear;
  ...
  }
  {
    ...
    auto actual_pose = state_history[fuse_core::TimeStamp(2, 0)].pose;
    EXPECT_NEAR(expected_pose.x(), actual_pose.x(), 1.0e-9);
    EXPECT_NEAR(expected_pose.y(), actual_pose.y(), 1.0e-9);
    EXPECT_NEAR(expected_pose.angle(), actual_pose.angle(), 1.0e-9);

    auto expected_linear_velocity = tf2_2d::Vector2(0.0, 1.0);
    auto actual_linear_velocity = state_history[fuse_core::TimeStamp(2, 0)].velocity_linear;
    EXPECT_NEAR(expected_linear_velocity.x(), actual_linear_velocity.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_velocity.y(), actual_linear_velocity.y(), 1.0e-9);

    auto expected_yaw_velocity = 0.0;
    auto actual_yaw_velocity = state_history[fuse_core::TimeStamp(2, 0)].velocity_yaw;
    EXPECT_NEAR(expected_yaw_velocity, actual_yaw_velocity, 1.0e-9);

    auto expected_linear_acceleration = tf2_2d::Vector2(0.0, 1.0);
    auto actual_linear_acceleration = state_history[fuse_core::TimeStamp(2, 0)].acceleration_linear;
    EXPECT_NEAR(expected_linear_acceleration.x(), actual_linear_acceleration.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_acceleration.y(), actual_linear_acceleration.y(), 1.0e-9);
  }
  {
    ...
    auto actual_pose = state_history[fuse_core::TimeStamp(3, 0)].pose;
    EXPECT_NEAR(expected_pose.x(), actual_pose.x(), 1.0e-9);
    EXPECT_NEAR(expected_pose.y(), actual_pose.y(), 1.0e-9);
    EXPECT_NEAR(expected_pose.angle(), actual_pose.angle(), 1.0e-9);

    auto expected_linear_velocity = tf2_2d::Vector2(0.0, 2.0);
    auto actual_linear_velocity = state_history[fuse_core::TimeStamp(3, 0)].velocity_linear;
    EXPECT_NEAR(expected_linear_velocity.x(), actual_linear_velocity.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_velocity.y(), actual_linear_velocity.y(), 1.0e-9);

    auto expected_yaw_velocity = 0.0;
    auto actual_yaw_velocity = state_history[fuse_core::TimeStamp(3, 0)].velocity_yaw;
    EXPECT_NEAR(expected_yaw_velocity, actual_yaw_velocity, 1.0e-9);

    auto expected_linear_acceleration = tf2_2d::Vector2(0.0, 1.0);
    auto actual_linear_acceleration = state_history[fuse_core::TimeStamp(3, 0)].acceleration_linear;
    EXPECT_NEAR(expected_linear_acceleration.x(), actual_linear_acceleration.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_acceleration.y(), actual_linear_acceleration.y(), 1.0e-9);
  }
  {
    ...
    auto actual_pose = state_history[fuse_core::TimeStamp(4, 0)].pose;
    EXPECT_NEAR(expected_pose.x(), actual_pose.x(), 1.0e-9);
    EXPECT_NEAR(expected_pose.y(), actual_pose.y(), 1.0e-9);
    EXPECT_NEAR(expected_pose.angle(), actual_pose.angle(), 1.0e-9);

    auto expected_linear_velocity = tf2_2d::Vector2(4.4, 5.4);
    auto actual_linear_velocity = state_history[fuse_core::TimeStamp(4, 0)].velocity_linear;
    EXPECT_NEAR(expected_linear_velocity.x(), actual_linear_velocity.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_velocity.y(), actual_linear_velocity.y(), 1.0e-9);

    auto expected_yaw_velocity = 6.4;
    auto actual_yaw_velocity = state_history[fuse_core::TimeStamp(4, 0)].velocity_yaw;
    EXPECT_NEAR(expected_yaw_velocity, actual_yaw_velocity, 1.0e-9);

    auto expected_linear_acceleration = tf2_2d::Vector2(7.4, 8.4);
    auto actual_linear_acceleration = state_history[fuse_core::TimeStamp(4, 0)].acceleration_linear;
    EXPECT_NEAR(expected_linear_acceleration.x(), actual_linear_acceleration.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_acceleration.y(), actual_linear_acceleration.y(), 1.0e-9);
  }
  {
    ...
    auto actual_pose = state_history[fuse_core::TimeStamp(5, 0)].pose;
    EXPECT_NEAR(expected_pose.x(), actual_pose.x(), 1.0e-9);
    EXPECT_NEAR(expected_pose.y(), actual_pose.y(), 1.0e-9);
    EXPECT_NEAR(expected_pose.angle(), actual_pose.angle(), 1.0e-9);

    auto expected_linear_velocity = tf2_2d::Vector2(11.8, 13.8);
    auto actual_linear_velocity = state_history[fuse_core::TimeStamp(5, 0)].velocity_linear;
    EXPECT_NEAR(expected_linear_velocity.x(), actual_linear_velocity.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_velocity.y(), actual_linear_velocity.y(), 1.0e-9);

    auto expected_yaw_velocity = 6.4;
    auto actual_yaw_velocity = state_history[fuse_core::TimeStamp(5, 0)].velocity_yaw;
    EXPECT_NEAR(expected_yaw_velocity, actual_yaw_velocity, 1.0e-9);

    auto expected_linear_acceleration = tf2_2d::Vector2(7.4, 8.4);
    auto actual_linear_acceleration = state_history[fuse_core::TimeStamp(5, 0)].acceleration_linear;
    EXPECT_NEAR(expected_linear_acceleration.x(), actual_linear_acceleration.x(), 1.0e-9);
    EXPECT_NEAR(expected_linear_acceleration.y(), actual_linear_acceleration.y(), 1.0e-9);
  }
}
