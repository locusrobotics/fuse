...
latex_documents = [
    (master_doc, 'fuse.tex', u'fuse Documentation',
     u'Stephen Williams', 'manual'),
]
...
man_pages = [
    (master_doc, 'fuse', u'fuse Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fuse', u'fuse Documentation',
     author, 'fuse', 'graph-based nonlinear state estimation',
     'Miscellaneous'),
]
