...
* The motion models are a plugin-based. If an adequate motion model is not available, the user is able to write their own models for the specifics of their robot.
